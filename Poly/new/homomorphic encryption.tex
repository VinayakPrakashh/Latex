...
\title{\hspace{10pt}HOMOMORPHIC ENCRYPTION\\


}

\author{\IEEEauthorblockN{\hspace{33pt}Vinayak Prakash}
\textit{\hspace{33pt}Semester 6}\\
\IEEEauthorblockA{\textit{\hspace{33pt}Department of Computer Engineering} \\
\textit{\hspace{33pt}Government Polytechnic College }\\
\textit{\hspace{33pt}Perumbavoor,Koovappady}\\
\hspace{33pt}vinayakprakash2121@gmail.com}
\and

\IEEEauthorblockN{\hspace{75pt}Chinchu Paulose}
\textit{\hspace{75pt}Lecturer}\\
\IEEEauthorblockA{\textit{\hspace{75pt}Department of Computer Engineering} \\
\textit{\hspace{75pt}Government Polytechnic College}\\
\textit{\hspace{75pt}Perumbavoor,Koovappady}\\
\hspace{75pt}chinchu432@gmail.com}
\and
}
...
\begin{IEEEkeywords}
Literature Review,Methodology,Encryption Algorithm,Security Analysis,Implementation of Schemes
\end{IEEEkeywords}
...
\bibitem{b1} Stinson, D. R. (2005). Cryptography: theory and practice (Vol. 55). Boca Raton, FL: CRC press.
\bibitem{b2} Boneh, D.,Shacham, H. (2004). Group signatures with verifier-local revocation. In Proceedings of the 13th ACM conference on Computer and communications security (pp. 424-433).
\bibitem{b3} Menezes, A. J., van Oorschot, P. C.,  Vanstone, S. A. (1997). Handbook of applied cryptography. CRC press.
\bibitem{b4} Goldreich, O. (2001). Foundations of cryptography: basic tools. Cambridge University Press.
\bibitem{b5} Bellare, M., Rogaway, P. (1993). Optimal asymmetric encryption—how to encrypt with RSA. In Advances in Cryptology—CRYPTO'93 (pp. 92-111). Springer, Berlin, Heidelberg.
\end{thebibliography}
\vspace{12pt}
