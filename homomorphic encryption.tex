...
\author{\IEEEauthorblockN{Biju Peter}
\IEEEauthorblockA{\textit{Head of Department in Computer Engineering} \\
\textit{Government Polytechnic College Perumbavoor}\\
bijupeter@gmail.com}
\and
\centering
\IEEEauthorblockN{Jiby P Joseph}
\IEEEauthorblockA{\textit{Lecturer in Computer Engineering} \\
\textit{Government Polytechnic College Perumbavoor}\\
jibypjoseph@gmail.com}
\and
}
...
\bibitem{b6} Diffie, W.,  Hellman, M. E. (1976). New directions in cryptography. IEEE transactions on information theory, 22(6), 644-654.
\end{thebibliography}
\vspace{12pt}
